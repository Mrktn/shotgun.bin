...
<form class="form-horizontal" action="index.php?activePage=new_shotgun&todoShotgun=create_shotgun" method="post" >
  ...
  <div class="form-group cache" id="Nb_places" >
      ...
      <div class="col-sm-10">
          <input type="number" name="nb_places" class="col-sm-2 control-label" id="inputNb_places3">
      </div>
  </div>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
  ...
  <div class="form-group cache" id="PrixQ">
      ...
      <div class="col-sm-10">
          <input type="number" name="prix" class="col-sm-2 control-label" id="inputPrix3">
      </div>
  </div>
  <div class="form-group">
