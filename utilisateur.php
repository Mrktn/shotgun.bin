...
class utilisateur {
    ...
    public static function getUtilisateur($dbh, $mail) { // renvoie l'utilisateur sous la classe utilisateur s'il existe et false sinon
    ...
    public static function getShotgun($dbh, $mail) { // Donne la liste des shotguns auxquels participe l'utilisateur
