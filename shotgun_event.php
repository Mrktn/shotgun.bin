...
class shotgun_event {
    ...
    public static function insererShotgun($dbh, $id, $titre, $description, $date_event, $date_publi, $nb_places, $prix, $mail_crea, $au_nom_de ) { // créer un nouveau shotgun
    ...
    public static function getShotgun($dbh, $id) { // renvoie le shotgun d'id id et faux sinon , fait-on la même avec en paramètre titre?
    ...
    public static function getParticipants($dbh, $id) { // Donne la liste des participants au shotgun #id
    ...
    public static function getQuestions($dbh, $id) { // Donne la liste des questions associées au shotgun #id
