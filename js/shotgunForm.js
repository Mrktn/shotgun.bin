// Cette page contient le javascript relatif à la création de questions et de choix pour l'implémentation d'un shotgun. Il contient entre autre le code HTML générant les questions et choix
...
;
var max_fields = 10; //Nombre de champs maximum (maximum 10 questions et 10 choix
...
$(document).ready(function () {
    ...
    $(wrapperQ).on("click", ".enleve_boutonQ", function (e) { //Bouton de suppression de question
        ...
        xQ--;
        // Il faut actualiser le nombre de choix pour chaque question
...
// Supprime la question p (objet) d'id s
function suppr(s,p) {
